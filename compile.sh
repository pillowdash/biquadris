...
g++20 -c game-impl.cc
g++20 -c main.cc
g++20 window.o window-impl.o observer.o observer-impl.o block.o Level.o Level-impl.o Board.o Viewver.o Viewver-impl.o game.o game-impl.o main.o -o test -lX11
rm *.o
